...
//calObj[0].month["0-4"] = 'Sun;第2月曜日'; // 第2火曜日はSunクラス指定
//calObj[0].month["2-2"] = 'Sun;第2火曜日は定休日です☆'; // 第2火曜日はSunクラス指定
//calObj[0].month["2-4"] = 'Sun;第4火曜日は定休日です☆'; // 第4火曜日はSunクラス指定
// 固定月「月-曜日-第○」 日:0 / 月:1 / 火:2 / 水:3 / 木:4 / 金:5 / 土:6
calObj[0].month["1-1-2"] = 'Sun;成人の日'; // 1月 月曜日(1) 第2 ということね。
calObj[0].month["7-1-3"] = 'Sun;海の日'; // 7月 月曜日(1) 第3 ということね。
calObj[0].month["9-1-3"] = 'Sun;敬老の日'; // 9月 月曜日(1) 第3 ということね。
calObj[0].month["10-1-2"] = 'Sun;体育の日'; // 10月 月曜日(1) 第2 ということね。
...
//teranaka追記
calObj[0].week[1] = 'Holyday;定休日'
calObj[0].week[2] = 'Holyday;定休日'
...
// Sun と指定した場合はclassがSun指定された日付だけクリックできるようになります。
calObj[0].clickClassName = "";

// 優先度 クラス指定する順番が変わります。
calObj[0].priority = new Array('week', 'week2', 'xDay','xDaysLater','day', 'backward');
...
function cal_create(calId){
	...
	for(dayCnt=1;dayCnt<=(calObj.days[month]+bisDay);dayCnt++){
		...
		if(calObj[calId].month[weekStr] != undefined)
			dayClass["week2"] = calObj[calId].month[weekStr];
		else if(calObj[calId].month[monStr] != undefined)
			dayClass["week2"] = calObj[calId].month[monStr];
